...
print(f"\n🧹 Let's create your magical story at Hogwarts School of Witchcraft and Wizardry! 🧹\n")
...
story = f"""
🌟 Once upon a time, {name}, a proud {place} student known for their {house_trait},
...
With laughter, magic, and friendship all around, it was truly a day to remember at Hogwarts. 🌈✨
"""

print(story)
print(f"\n🎉 Thank you for playing, {name}! Your Hogwarts adventure awaits! 🎉\n")